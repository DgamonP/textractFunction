...
Se implemento el servicio de Textract en una API, sobre una funcion Lambda en AWS
...
https://i6z4bkj3g8.execute-api.us-east-1.amazonaws.com/default/getTextFromImage 
...
Please read [CONTRIBUTING.md](https://gist.github.com/dgamonp) 

## Authors

* **Billie Thompson** - *Initial work* - [PurpleBooth](https://github.com/dgamonp)
